    ...
    <div className="main">
      ...
      <div>
        ...
        <p>
          ...
          fields. I am now looking to get off the road and start a new career as a software
          developer, utilising the knowledge I have gained, my experience working with
        ...
        <ul className={css.cvList}>
          ...
          <li>
            ...
            (
            <Anchor name="opensourcemuzic.com/dnn" link="https://opensourcemuzic.com/dnn/" />
            )
          </li>
          <li>
            ...
            (
            <Anchor name="sharetrader.stevebunting.com" link="http://sharetrader.stevebunting.com/" />
            )
          </li>
          <li>
            ...
            systems
            (
            <Anchor name="rfxp.stevebunting.com" link="https://rfxp.stevebunting.com/" />
            )
          </li>
          <li>
            ...
            (
            <Anchor name="rflibrary.stevebunting.com" link="https://rflibrary.stevebunting.com/" />
            )
          </li>
        </ul>
        ...
        <p>
          ...
          Pixie Lott, Leona Lewis, Jason Derulo among others. Events included worldwide tours,
          one-offs, festivals and corporate events.
        </p>

        <p>
          The job required a large number of skills, including:
        </p>

        <ul className={css.cvList}>
          <li>
            Working with a variety of demanding teams in fast-paced environments and high stress
            situations.
          </li>
          <li>
            An understanding of the needs of fellow musicians and the ability to accurately
            represent their artistic vision into technical reality.
          </li>
          <li>
            Experience operating, configuring and setting-up a wide variety of complex professional
            sound reinforcement equipment, including most modern digital mixing consoles, DSP and
            line arrays, with the ability to rapidly adapt when faced with unknown hardware.
          </li>
          <li>
            Knowledge and operation of popular digital audio workstations and other audio software,
            including Logic X and Waves.
          </li>
          <li>
            A comprehensive knowledge and understanding of radio technology and coordination.
          </li>
          <li>
            Practical expertise of dual-FFT based audio analysis equipment.
          </li>
          <li>
            Logical understanding of signal flow and using test equipment for rapid fault-finding.
          </li>
          <li>
            Considerable IT knowledge of wired/wireless networking, audio control software and
            array prediction.
          </li>
          <li>
        ...
        <ul className={css.cvList}>
          ...
          <li>
            CS50: Introduction to Computer Science (edX) (May 2017)
          </li>
          <li>
            Graduate with 2:1 classification from the BMus (Hons) Music and Sound Recording
            (Tonmeister) course of the University of Surrey (June 2005)
          </li>
          <li>
            Associateship of the University of Surrey with Distinction (June 2005)
          </li>
          <li>
            ‘A’ Levels in Maths (A), Physics (A) and Music Technology (A) with an ‘AS’ level in
            Further Maths (A)
          </li>
        </ul>
        ...
        <ul className={css.cvList}>
          <li>
            ...
            meticulous and exacting standards.
          </li>
          <li>
            I am adaptable, quick to learn new technologies, workflows and best practices and
            always looking to expand my knowledge.
          </li>
          <li>
            Native English speaker with working Swedish language.
          </li>
        </ul>
